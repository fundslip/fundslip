  ...
  return (
    <section className="relative py-24 md:py-32 px-5 md:px-8 overflow-hidden">
      ...
      <div className="container-page">
        ...
        {/* Three big step cards */}
        <div className="space-y-4">
          {/* Step 1 — Generate */}
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            transition={{ duration: 0.5, ease }}
            className="group grid grid-cols-1 md:grid-cols-2 gap-0 bg-white rounded-2xl border border-black/[0.05] overflow-hidden hover:shadow-card-hover hover:-translate-y-[1px] transition-all duration-300">
            <div className="p-7 md:p-10 flex flex-col justify-center">
              ...
              <p className="mt-3 text-on-surface-variant text-[14px] leading-relaxed">
                Connect your wallet, choose the period, and get a clean PDF. Real balances, real transactions, real credibility — formatted for institutions.
              </p>
            ...
            <div className="bg-gradient-to-br from-[#f5f7fa] to-[#eef0f5] p-6 md:p-10 flex items-center justify-center min-h-[200px]">
              {/* Mini preview of a statement */}
              <div className="w-full max-w-[280px] bg-white rounded-xl shadow-card p-4 text-[11px] space-y-3">
                <div className="flex justify-between items-center">
                  <span className="font-headline font-bold text-[12px]">FUNDSLIP</span>
                  <span className="px-1.5 py-0.5 rounded bg-tertiary/10 text-tertiary text-[8px] font-bold uppercase">Verified</span>
                </div>
                <div>
                  <p className="text-[8px] uppercase tracking-wider text-on-surface-variant mb-0.5">Net Worth</p>
                  <p className="text-xl font-headline font-extrabold tabular-nums">$142,502</p>
                </div>
                <div className="space-y-1">
                  <div className="flex justify-between py-1 border-t border-black/[0.04]">
                    <span className="text-on-surface-variant">ETH</span><span className="font-semibold tabular-nums">$84,120</span>
                  </div>
                  <div className="flex justify-between py-1 border-t border-black/[0.04]">
                    <span className="text-on-surface-variant">USDC</span><span className="font-semibold tabular-nums">$58,382</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center">
                    <Fingerprint className="w-4.5 h-4.5 text-white/80" />
                  </div>
                ...
                <p className="mt-3 text-white/40 text-[14px] leading-relaxed">
                  Your wallet signs a structured message binding your identity to the data. Change one byte — the signature breaks.
                </p>
                <div className="mt-6 flex items-center gap-3">
                  <Lock className="w-3.5 h-3.5 text-white/30" />
                  <span className="text-[11px] text-white/30">Zero-server · Client-side only · Private keys never leave your device</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <Link href="/verify" className="inline-flex items-center gap-1.5 mt-6 text-[13px] font-semibold text-primary group/l">
